            ...
            <div>
              ...
              <div className='userContent'>
                ...
                <Table success bordered hover responsive striped className='userTable table-success'>
                  ...
                  <tbody>
                    {currentElements.map((totalReg, index) => (
                      (totalReg.AccountsEur?.acceur_Bank !== 'Ghost' &&
                        ...
                        <tr key={totalReg.tor_id}>
                          ...
                          <td>{Number(totalReg.tor_currencyPrice).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        </tr>
                      ) : null
                    ))}
                  </tbody>
                ...
                <Pagination>
                  {Array(Math.ceil(filteredRelation.length / elementsPerPage))
                    .fill()
                    .map((_, i) => (
